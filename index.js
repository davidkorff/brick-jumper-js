//START OF GAME!!! AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAa
score1=0
score2=0
gameGoing = true
...
function moveWallLeft(object){
  let leftPosition = getLeftPosition(object)
  object.style.left = `${leftPosition - 1}px`
  if (leftPosition < -10) {
...
function checkBullet1Collision(){ //checks if dodger2 was hit by 1
  dodger2LeftPosition = getLeftPosition(dodger2)
  dodger2HeightPosition = getBottomPosition(dodger2)
...
function checkBullet2Collision(){ //checks if dodger1 was hit by 2
  dodger1LeftPosition = getLeftPosition(dodger1)
  dodger1HeightPosition = getBottomPosition(dodger1)
...
function jumpListener(jumpNum){
  document.addEventListener('keydown', jumpNum)
}
